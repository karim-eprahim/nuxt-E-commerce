    ...
    <div class="max-w-4xl mx-auto">
      ...
      <form @submit.prevent="onSubmit" class="space-y-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <FormField v-slot="{ componentField }" name="name">
              <FormItem>
                ...
                <FormControl>
                  <Input v-bind="componentField" :disabled="isLoading" placeholder="e.g. Classic White Sneaker"
              ...
              <FormItem>
                ...
                <FormControl>
                  <div class="relative">
                    ...
                    <Input v-bind="componentField" type="number" step="0.01" min="0" :disabled="isLoading"
                      placeholder="0.00" class="h-10 rounded-lg pl-7 transition-all" />
                  </div>
                </FormControl>
                    ...
                    <SelectContent>
                      <SelectItem v-for="color in colors" :key="color.id" :value="color.id">
                        <div class="flex items-center gap-2">
                          <span class="w-3.5 h-3.5 rounded-full border inline-block flex-shrink-0"
        ...
        <div class="flex items-center gap-3 pt-2 border-t">
          <Button type="submit" :disabled="isLoading" class="font-medium px-6 h-10 rounded-lg gap-2 transition-all">
